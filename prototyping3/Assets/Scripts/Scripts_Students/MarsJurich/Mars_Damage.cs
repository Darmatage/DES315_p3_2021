...
public class Mars_Damage : MonoBehaviour{
    ...
    private float savedPowerFront = 5f;
    private float savedPowerBack = 5f;
    private float savedPowerLeft = 5f;
    private float savedPowerRight = 5f;
    private float savedPowerTop = 5f;
    private float savedPowerBottom = 5f;
    ...
    private void SetShieldLevels()
    {
        Mars_Weapon marsWeapon = gameObject.GetComponent<Mars_Weapon>();

        if (marsWeapon.IsOnCooldown() != oldResult)
        {
            if (marsWeapon.IsOnCooldown())
            {
                savedPowerFront = shieldPowerFront;
                savedPowerBack = shieldPowerBack;
                savedPowerLeft = shieldPowerLeft;
                savedPowerRight = shieldPowerRight;
                savedPowerTop = shieldPowerTop;
                savedPowerBottom = shieldPowerBottom;
            ...
            {
                shieldPowerFront = savedPowerFront;
                shieldPowerBack = savedPowerBack;
                shieldPowerLeft = savedPowerLeft;
        ...
        oldResult = marsWeapon.IsOnCooldown();
    }
