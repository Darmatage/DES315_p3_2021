...
public class ZMB_Damage : MonoBehaviour
{
    ...
    void Start()
    {
	    ...
	    sidelimit = ds.sidelimit;
	    knockBackSpeed = ds.knockBackSpeed;
	    shieldPowerBack = ds.shieldPowerBack;
	    shieldPowerFront = ds.shieldPowerFront;
	    shieldPowerLeft = ds.shieldPowerLeft;
	    shieldPowerRight = ds.shieldPowerRight;
	    shieldPowerTop = ds.shieldPowerTop;
	    shieldPowerBottom = ds.shieldPowerBottom;
	    
    	shieldFrontObj = ds.shieldFrontObj;
    	shieldBackObj = ds.shieldBackObj;
    	shieldLeftObj = ds.shieldLeftObj;
    	shieldRightObj = ds.shieldRightObj;
    	shieldTopObj = ds.shieldTopObj;
    	shieldBottomObj = ds.shieldBottomObj;

    	dmgParticlesFront = ds.dmgParticlesFront;
    	dmgParticlesBack = ds.dmgParticlesBack;
    	dmgParticlesLeft = ds.dmgParticlesLeft;
    	dmgParticlesRight = ds.dmgParticlesRight;
    	dmgParticlesTop = ds.dmgParticlesTop;
